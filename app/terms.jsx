...
export default function Terms() {
  return (
    <main>
      <div className="hero max-h-[300px]">
        ...
        <div className="hero-content text-center text-accent">
          <div className="max-w-2xl text-pretty">
            ...
            <p className="py-6 text-2xl text-accent-content font-semibold">
      ...
      <section className="block bg-base-100 text-wrap">
        <div className="mx-auto">
          <div className="flex justify-center">
            <div className="max-w-11/12 lg:w-10/12 px-4">
              <div className="relative flex flex-col min-w-0 break-words w-full mt-8 mb-6 shadow-lg rounded-lg bg-base-100">
                <div className="flex-auto p-5 lg:p-10">
                  ...
                  <div className="relative w-full mb-3 mt-8">
                    <p className="leading-relaxed mt-1 mb-4 flex-wrap">
