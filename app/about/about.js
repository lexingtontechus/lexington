    ...
    <main>
      ...
      <section className="container mx-auto p-8">
        ...
        <div className="text-center pt-8">
          ...
          <div className="align-center my-4 noflex space-4">
            <button
              className="btn btn-square tooltip mx-2"
            ...
            >
              <Link
                ...
                target="_blank"
              >
                <span className="text-2xl text-lime-600 font-black size-8">
                  B
                </span>
              </Link>
            </button>
            <button className="btn btn-square tooltip mx-2" data-tip="LinkedIn">
              <Link
            ...
            <button className="btn btn-square tooltip mx-2" data-tip="Medium">
              <Link href="https://medium.com/@lexingtontech" target="_blank">
                <Medium />
              </Link>
            </button>
            <button className="btn btn-square tooltip mx-2" data-tip="Substack">
