        ...
        <div className="flex flex-wrap gap-4 content-center justify-center">
          <div className="grow card card-compact w-full md:w-3/12 bg-secondary text-primary-content">
            ...
            <div className="card-body p-4">
              <h2 className="card-title font-bold">Our Mission</h2>
          ...
          <div className="grow card card-compact w-full md:w-3/12 bg-secondary text-primary-content">
            ...
            <div className="card-body p-4">
              <h2 className="card-title font-bold">Our Technologies</h2>
          ...
          <div className="grow card card-compact w-full md:w-3/12 bg-secondary text-primary-content">
            ...
            <div className="card-body p-4">
              <h2 className="card-title font-bold">Our Approach</h2>
