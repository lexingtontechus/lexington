...
export default function Terms() {
  return (
    <>
      <Head>
        <title>Lexington | Terms of Service</title>
        <meta
                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-indigo-200">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mb-3 mt-8">
                      <p className="leading-relaxed mt-1 mb-4 text-indigo-500">
                        ...
                        accept and comply with these Terms of Use. You agree
                        that by accessing the Site and/or the Marketplace
                        Offerings, you have read, understood, and agree to be
                      ...
                      <p className="leading-relaxed mt-1 mb-4 text-indigo-500">
                        ...
                        you may not use this Site. You may not use the Site in a
                      ...
                      <p className="leading-relaxed mt-1 mb-4 text-indigo-500">
                        ...
                        the Marketplace Offerings are hosted in the United
                        States. If you access the Site or the Marketplace
